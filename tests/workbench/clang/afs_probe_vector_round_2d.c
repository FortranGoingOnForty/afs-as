/* Workbench note: probe the float64 SIMD rounding neighborhood after landing
 * the `.4s` rounding family, to see whether clang emits `frintn.2d`,
 * `frintm.2d`, `frintp.2d`, `frintz.2d`, `frinta.2d`, and `frinti.2d`.
 */
#include <arm_neon.h>
