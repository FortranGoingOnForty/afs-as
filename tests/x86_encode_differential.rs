...
const CASES: &[&str] = &[
    ...
    "pshuflw $27, %xmm8, %xmm10",
    "pshuflw $228, 16(%rax), %xmm3",
    "pshuflw $-128, %xmm1, %xmm2",
    "pshuflw $255, %xmm1, %xmm2",
    "psrldq $0, %xmm0",
    "psrldq $8, %xmm0",
    "psrldq $15, %xmm12",
    "psrldq $255, %xmm12",
    ...
    "cmppd $1, %xmm2, %xmm9",
    "cmppd $6, %xmm0, %xmm1",
    // Sprint 23 (cgfried): cmovcc r/m -> r (0F 4x)
    "cmovneq %rax, %rbx",
    "cmoveq %r12, %rdi",
    "cmovll %ecx, %edx",
    "cmovaeq -8(%rbp), %r9",
    "cmovbl 16(%rsp), %eax",
    "cmovgeq %r15, %rax",
    // Sprint 23 (cgfried): the closed x87 long-double whitelist.
    "fldt -16(%rbp)",
    "fldt 32(%rsp)",
    "fldl (%rax)",
    "flds 8(%rbx)",
